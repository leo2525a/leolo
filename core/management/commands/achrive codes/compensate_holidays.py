...
from decimal import Decimal # <--- IMPORT aDDED HERE
            ...
            for holiday in public_holidays:
                ...
                if holiday_weekday not in work_days:
                    ...
                    adjustment, created = LeaveBalanceAdjustment.objects.get_or_create(
                        ...
                        # 【FIX #1】Use Decimal for the default value
                        defaults={'hours_changed': Decimal('8.00')} 
                    )
                    ...
                    if created:
                        ...
                        # 【FIX #2】Use Decimal for the calculation
                        balance.balance_hours += Decimal('8.00')
                        balance.save()
